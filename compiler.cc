...
int main(int argc, char** argv) {
	...
	tflite::MicroInterpreter interpreter(model, resolver, arena_buf.data(), tensor_arena_size, error_reporter);
	...
	dump_data(prefix, &interpreter, model_buf.data(), model_buf.data() + model_len, arena_buf.data(), arena_buf.data() + tensor_arena_size);
